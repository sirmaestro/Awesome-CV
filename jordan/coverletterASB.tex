...
\recipient
  ...
  {ASB Group \\ASB North Wharf\\12 Jellicoe Street\\Auckland 1010}
% The date on the letter, default is the date of compilation
\letterdate{\today}
% The title of the letter
\lettertitle{Job Application for Start Me Up Engineer}
% How the letter is opened
\letteropening{Dear ASB,}
